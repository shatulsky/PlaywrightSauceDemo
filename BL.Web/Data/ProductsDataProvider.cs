...
// Products displayed on the UI are hardcoded in the JavaScript code.
// Therefore, it is acceptable to define them statically in this class as well.
public class ProductsDataProvider
{
    public ProductData[] AllProducts { get; } =
    [
        new(
            4,
            "Sauce Labs Backpack",
